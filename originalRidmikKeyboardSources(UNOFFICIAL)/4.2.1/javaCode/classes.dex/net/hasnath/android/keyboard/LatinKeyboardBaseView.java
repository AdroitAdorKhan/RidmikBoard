                    ...
                    if (this.themeIndex == LatinIME.LOLIPOP_THEME_INDEX || this.themeIndex == LatinIME.LOLIPOP_THEME_INDEX + 1) {
                        if (key.codes != null && key.codes[0] == 32) {
                            ...
                            if (this.themeIndex == LatinIME.LOLIPOP_THEME_INDEX) {
                                dr = getResources().getDrawable(R.drawable.btn_keyboard_key_popup_selected_lxx_dark);
                            } else {
                                dr = getResources().getDrawable(R.drawable.btn_keyboard_key_popup_selected_lxx_light);
                            }
                        ...
                        if (key.codes != null && (key.codes[0] == -1 || key.codes[0] == LatinIME.FIXED_BANGLA_NORMAL || key.codes[0] == LatinIME.FIXED_BANGLA_SHIFTED)) {
                            if (this.themeIndex == LatinIME.LOLIPOP_THEME_INDEX) {
                                if (getKeyboard().isShifted()) {
                                    key.icon = getResources().getDrawable(R.drawable.sym_keyboard_shift_locked_lxx_dark);
                                } else {
                                    key.icon = getResources().getDrawable(R.drawable.sym_keyboard_shift_lxx_dark);
                                }
                            } else if (getKeyboard().isShifted()) {
                                key.icon = getResources().getDrawable(R.drawable.sym_keyboard_shift_locked_lxx_light);
                            } else {
                                key.icon = getResources().getDrawable(R.drawable.sym_keyboard_shift_lxx_light);
                            }
                        }
                        if (key.codes != null && key.codes[0] == 10) {
                            key.icon = getResources().getDrawable(R.drawable.enter);
                        }
                        if (key.codes != null && key.codes[0] == -5) {
                            if (this.themeIndex == LatinIME.LOLIPOP_THEME_INDEX) {
                                key.icon = getResources().getDrawable(R.drawable.sym_keyboard_delete_lxx_dark);
                            } else {
                                key.icon = getResources().getDrawable(R.drawable.sym_keyboard_delete_lxx_light);
                            }
                        }
                    }
