...
public class LatinKeyboard extends Keyboard {
    ...
    private static final String NATIONAL_STRING_ASCII = "ÂðÅ³Ý";
    ...
    private static final String UNIJOY_STRING_ASCII = "²´ãÎÂÝ";
    private static final String UNIJOY_STRING_UNICODE = "ইউনিজয়";
        ...
        if (this.mEnterKey != null) {
            ...
            switch (1073742079 & options) {
                ...
                default:
                    ...
                    this.mEnterKey.icon = res.getDrawable(this.mIsBlackSym ? R.drawable.sym_bkeyboard_return : R.drawable.sym_keyboard_return_smiley);
                    this.mEnterKey.label = null;
                    break;
            }
