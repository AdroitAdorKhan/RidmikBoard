...
public class KeyboardSwitcher implements OnSharedPreferenceChangeListener {
    private static final int[] ALPHABET_MODES = new int[]{2131165216, 2131165217, 2131165218, 2131165219, 2131165220, 2131165221, 2131165222, 2131165223, 2131165224, 2131165225};
    ...
    private static final int[] THEMES = new int[]{R.layout.input_basic, R.layout.input_basic_highcontrast, R.layout.input_stone_normal, R.layout.input_stone_bold, R.layout.input_gingerbread, R.layout.input_ics, R.layout.input_iphone, R.layout.input_ridmik_blue};
    ...
    private KeyboardId getKeyboardId(int mode, int imeOptions, boolean isSymbols) {
        ...
        if (LatinIME.langNow == 1) {
            if (useAsciiLayout()) {
                keyboardRowsResId = KBD_QWERTY_BANGLA_ASCII[charColorId];
            } else {
                keyboardRowsResId = KBD_QWERTY_BANGLA[charColorId];
            }
        }
        int i2;
        if (!isSymbols) {
            ...
            switch (mode) {
                ...
                case 4:
                    return new KeyboardId(keyboardRowsResId, this.mHasSettingsKey ? 2131165222 : 2131165217, true, hasVoice);
                case 5:
                    return new KeyboardId(keyboardRowsResId, this.mHasSettingsKey ? 2131165223 : 2131165218, true, hasVoice);
                case 6:
                    return new KeyboardId(keyboardRowsResId, this.mHasSettingsKey ? 2131165224 : 2131165219, true, hasVoice);
                case 7:
                    return new KeyboardId(keyboardRowsResId, this.mHasSettingsKey ? 2131165225 : 2131165220, true, hasVoice);
                case 8:
                    return new KeyboardId(KBD_SMILEY[0], 2131165216, false, hasVoice);
                case 9:
                    return new KeyboardId(KBD_SMILEY[1], 2131165216, false, hasVoice);
                case 10:
                    return new KeyboardId(KBD_SMILEY[2], 2131165216, false, hasVoice);
                case 11:
                    int xmlResId = 0;
                    ...
                    return new KeyboardId(xmlResId, 2131165216, false, hasVoice);
                case 12:
                    int xmlResId1 = 0;
                    if (CURRENT_FIXED_LAYOUT == 1) {
                        if (useAsciiLayout()) {
                    ...
                    return new KeyboardId(xmlResId1, 2131165216, false, hasVoice);
                default:
                    return null;
            }
            if (this.mHasSettingsKey) {
    ...
    private void updateSettingsKeyState(SharedPreferences prefs) {
        ...
        if (settingsKeyMode.equals(resources.getString(2131230843)) || (settingsKeyMode.equals(resources.getString(R.string.settings_key_mode_auto)) && LatinIMEUtil.hasMultipleEnabledIMEs(this.mInputMethodService))) {
