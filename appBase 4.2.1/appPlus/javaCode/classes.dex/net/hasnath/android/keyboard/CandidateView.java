...
public class CandidateView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.mService == null || !(this.mService.mKeyboardSwitcher.getLayoutId() == LatinIME.LOLIPOP_THEME_INDEX || this.mService.mKeyboardSwitcher.getLayoutId() == LatinIME.LOLIPOP_THEME_INDEX + 1)) {
            ...
            this.mColorOther = getContext().getResources().getColor(R.color.candidate_recommended);
        } else {
            this.mColorNormal = getContext().getResources().getColor(R.color.candidate_normal_lolipop);
            this.mColorRecommended = getContext().getResources().getColor(R.color.candidate_recommended_lolipop);
            this.mColorOther = getContext().getResources().getColor(R.color.candidate_recommended_lolipop);
        }
